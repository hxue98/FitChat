...
class DiscussionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSendMsg = (Button) findViewById(R.id.user_chat_send);
        etMsg = (EditText) findViewById(R.id.user_chat_textfield);

        lvDiscussion = (ListView) findViewById(R.id.user_chat_listview);
